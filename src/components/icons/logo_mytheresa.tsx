...
const LogoMytheresa = () => {
  return (
    ...
    >
      ...
      />
      <polygon className="fil0" points="1333 2 1195 2 1499 529 1569 412" />
      <polygon
        className="fil0"
        points="1874 2 1524 580 1524 959 1662 959 1662 580 2012 2"
      />
      <polygon className="fil0" points="933 959 1070 959 1070 2 933 2" />
      <polygon className="fil0" points="413 959 551 959 795 406 795 94" />
      <polygon className="fil0" points="511 617 239 2 101 2 442 773" />
      <polygon className="fil0" points="0 959 138 959 138 407 0 94" />
    </svg>
  );
};

export default LogoMytheresa;
